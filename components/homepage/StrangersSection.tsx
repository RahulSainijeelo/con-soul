...
export function StrangersSection() {
  return (
    <section className="py-24 -mt-[30px] md:mt-6 bg-gradient-to-b from-[#0f0a12] to-[#0a080d] relative z-40 overflow-hidden" style={{ borderRadius: "40px 40px 0 0", borderTop: "1px solid rgba(168, 85, 247, 0.08)", boxShadow: "0 -8px 30px rgba(0,0,0,0.6)" }}>
      {/* Background glow */}
